<!DOCTYPE html>
<head><title>Ryland Rubens MD5 Cracker</title></head>
<body>
<h1>MD5 cracker adapted from Ryland Rubens <a href="https://github.com/csev/wa4e/tree/master/code/crack">wa4e</a></h1>
...
if ( isset($_GET['md5']) ) {
    ...
    for($i=0; $i<strlen($txt); $i++ ) {
        ...
        //inner loop for second character
        for($j=0; $j<strlen($txt); $j++ ) {
            $ch2 = $txt[$j];
            //inner loop for third character
            for($k=0; $k<strlen($txt); $k++ ) {
                $ch3 = $txt[$k]; 
                //inner loop for fourth character    
